...
async function fetcher(url = '', method = 'POST', data = {}) {
...
function findFilm(title) {
    ...
    try {
        const result = fetcher('/api/v1/films/find', 'POST', data);
...
function createFilm() {
    ...
    try {
        const result = fetcher('/api/v1/films/create', 'POST', data);
...
function deleteFilm(id) {
    ...
    try {
        const result = fetcher('/api/v1/films/delete', 'DELETE', data);
...
function deleteAllFilms() {
    try {
        const result = fetcher('/api/v1/films/deleteAll', 'DELETE');
